  ...
  $.extend($.flexselect.prototype, {
    ...
    wire: function() {
      ...
      this.input.click(function() {
        ...
        //self.focus(); //LW - allow position of carret where we want to change entry
        self.filterResults(); //LW
      });
      ...
      this.input.focus(function() {
        ...
        //[LW]: select only if previsouly blured
        //self.input.select();
        //if (!self.picked) //LW always show menu
        self.filterResults();
      });


      this.input.blur(function() {
      	  //LW, on blur always hide menu
...
//          self.dropdownList.show();
      ...
      this.dropdownList.mouseover(function(event) {
        return; //LW do not make any selection on mouse over
    ...
    filterResults: function(abbreviation) {
    ...
    renderDropdown: function() {
      ...
      $.each(this.results, function() {
        ...
        //[LW]: add title in order to display tool tip if label is wider than dropdown menu
        html += '<li title="'+this.name.replace('"', '')+'">' + this.name + '</li>';
      });
    ...
    pickSelected: function() {
      ...
      if (selected) {
        ...
        //add the option in the list
      	//[LW]: implement allowMismatch
      	this.select.append('<option title="'+this.input.val().replace('"', '')+'" value="'+this.input.val().replace('"', '')+'">'+this.input.val()+'</option>');
      	this.results[this.input.val().replace('"', '')] = this.input.val();
