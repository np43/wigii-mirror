...
/**
 * Created by CWE on March 23rd 2014
 */
class ServiceProviderCliExampleImpl extends ServiceProviderCliImpl
{
	...
	private function debugLogger()
	{
		...
		{
			$this->_debugLogger = DebugLogger::getInstance("ServiceProviderCliExampleImpl");
		}
	...
	{
		$instance = new ServiceProviderCliExampleImpl();
