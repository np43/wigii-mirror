<?php
/**
 * changed done by Lionel Weber
 * - 29.03.2012, add management of character &#39; replaced by '
 * - 30.03.2012, remove links management
 */
/*************************************************************************
*                                                                      *
* class.html2text.inc                                                  *
...
class Html2text
{
    ...
    */
    ...
    function clear(){
    	unset($this->_link_list);
    	unset($this->allowed_tags);
    	unset($this->text);
    	unset($this->html);
    	unset($this->url);
