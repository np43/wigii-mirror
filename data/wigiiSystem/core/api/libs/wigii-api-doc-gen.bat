...
call .\ApiGen-2.8.0-standalone\apigen --source ..\..\api\impl\RecordEvaluator.php --source ..\..\api\impl\ElementEvaluator.php --source ..\..\wfl\WigiiFL.php --source ..\..\wfl\FuncExpVMStdFL.php --source ..\..\wfl\PHPStdFL.php --source ..\..\wfl\FuncExpBuilder.php --source ..\..\wfl\WigiiWebSocketFL.php --source ..\..\..\configPack\WigiiOrg\company\CompanyElementEvaluator.php  --exclude "..\libs\*" --destination %DOC_OUTPUT%\wfl --title "Wigii Functional Expressions Reference" --groups "packages" --autocomplete "methods" --access-levels "public" --internal No --php No --tree No --update-check No
