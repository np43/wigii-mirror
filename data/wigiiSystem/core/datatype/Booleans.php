 ...
 * by LWR
 */
class Booleans extends DataTypeInstance {
	...
	*/
	public function checkValues($p, $elementId, $wigiiBag, $field){
		//pas de contrôle particulier puisque c'est une checkbox, et que la classe FormExecutor
		//s'occupe déjà de contrôler que cela correspond à ce que l'on a envoyé
	}
}
