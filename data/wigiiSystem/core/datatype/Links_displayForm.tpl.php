...
if($fieldXml["fsl"]!=""){
    ...
    if($fieldXml["isBlogView"]=="1") {
        $this->displayElementPListBlogPreview($this->getP(), $this->getFormRenderer()->getIsInLineWidth(), $this->getRecord(), $fieldName, $fsl, $fskl, /* Medair 08.01.2018: pagination is not implemented in blog view (string)$fieldXml["limit"]*/null);
    } else{
