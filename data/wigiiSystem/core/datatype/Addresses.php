 ...
 * by LWR
 */
class Addresses extends DataTypeInstance {
	const mainSubField = "street"; // pour le focus (entre autre)
	/**
	...
	*/
	public function checkValues($p, $elementId, $wigiiBag, $field){
		...
		//if (!is_numeric($get[$name."_zip_code"])) $form->add_error_to_field($formIndice, "zipCodeWrongFormat");
	}
}
