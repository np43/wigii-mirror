...
class PortalGroupFormExecutor extends FormExecutor {
	...
	protected function actOnCheckedRecord($p, $exec) {
		...
		try{
			...
			$oldRecord->getWigiiBag()->importFromSerializedArray($group->getDetail()->getPortal(), $oldRecord->getActivity());
			...
			$groupAS->setPortal($p, $group->getId(), $group->getDetail()->getPortal());
