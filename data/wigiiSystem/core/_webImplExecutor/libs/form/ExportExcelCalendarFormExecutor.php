		...
		switch($this->getRecord()->getFieldValue("excelCalendarTemplate")){
			case "excelCalendarAnnual":
				...
				//Dates case
					...
					$elementPList->setYear($this->getRecord()->getFieldValue("excelCalendarYear"), (string)$Axml->parameters["dateFieldname"], false, (string)$Axml->parameters["endDateFieldname"]);
				}
