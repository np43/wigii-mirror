...
/**
 * Removes the TestCases Module for admin user.
 * Created by CWE on 17 fév. 2010
 */
class CleanupTestCasesModule extends WigiiApiTest
{
	...
	private function d()
	{
		...
		{
			$this->_debugLogger = DebugLogger::getInstance("CleanupTestCasesModule");
		}
		return $this->_debugLogger;
	}
	public function __construct()
	{
		parent::__construct('CleanupTestCasesModule','Removes TestCases module for admin user');
	}
	...
	public function run()
	{
		...
		$mySqlF->updateField($rootPrincipal, FieldSelector::createInstance("moduleAccess"), "Users",
			...
			"TestCases", SUPDOP_DEL, $userAS->getSqlWhereClauseBuilderForSelectUsers(),
		...
		$this->assertNull("admin access to TestCases module has been removed", $dat->principal($dat->admin())->getModuleAccess("TestCases"));
	}
}
TestRunner::test(new CleanupTestCasesModule());