...
/**
 * Setups the TestCases Module for admin user.
 * Created by CWE on 17 fév. 2010
 */
class SetupTestCasesModule extends WigiiApiTest
{
	...
	private function d()
	{
		...
		{
			$this->_debugLogger = DebugLogger::getInstance("SetupTestCasesModule");
		}
		return $this->_debugLogger;
	}
	public function __construct()
	{
		parent::__construct('SetupTestcasesModule','Setups TestCases module for admin user');
	}
	...
	public function run()
	{
		...
		$mySqlF->updateField($rootPrincipal, FieldSelector::createInstance("moduleAccess"), "Users",
			...
			"TestCases", SUPDOP_ADD, $userAS->getSqlWhereClauseBuilderForSelectUsers(),
		...
		$this->assertNotNull("admin has access to Testcases module", $dat->principal($dat->admin())->getModuleAccess("TestCases"));
	}
}
TestRunner::test(new SetupTestCasesModule());