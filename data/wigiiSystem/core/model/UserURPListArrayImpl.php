...
/**
 * UserURPList array implementation
 * Created by LWR on 26 february 10
 */
class UserURPListArrayImpl extends ObjectListArrayImpl implements UserURPList
{
	...
	{
		if(!isset($userURP)) throw new ListException("userRP cannot be null", ListException::INVALID_ARGUMENT);
		$user = $userURP->getUserUR()->getUser();
