...
class PWithModuleWithElementIdsWithRecord extends BaseEventModel {
	...
	public static function createInstance($p, $module=MANDATORY_ARG, $elementIds=MANDATORY_ARG, $record=MANDATORY_ARG){
		$r = new self();
		$r->setP($p);
		$r->setModule($module);
