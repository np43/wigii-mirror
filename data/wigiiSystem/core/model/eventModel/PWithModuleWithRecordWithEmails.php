...
class PWithModuleWithRecordWithEmails extends BaseEventModel {
	...
	public static function createInstance($p, $module=MANDATORY_ARG, $record=MANDATORY_ARG, $emails=MANDATORY_ARG){
		$r = new self();
		$r->setP($p);
		$r->setModule($module);
		$r->setRecord($record);
