...
interface WigiiGraphNodeListener {
	 ...
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $oldValue the existing value which now changed
	 * @param $newValue the new set value
	 */
	 ...
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $key the key of the attribute which has been set
	 * @param $oldValue the existing value which now changed
	 * @param $newValue the new set value
	 */
	 ...
	 * This event is triggered only if the method listenToAttributeChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $oldAttributes an array with the existing attributes values (key=>value), which now changed
	 * @param $newAttributes an array with the new attributes values (key=>value)
	 */
	 ...
	 * This event is triggered only if the method listenToAttributeChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $attributes an array with the existing attributes values (key=>value), which have been removed
	 */
	 ...
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $linkName the name of the link which has been set
	 * @param $oldNode the existing linked WigiiGraphNode instance which now changed
	 * @param $newNode the new linked WigiiGraphNode
	 * @param $keptLinkAttributes if true, then means that the node changed, but the link attributes where preserved.
	 */
	 ...
	 * This event is triggered only if the method listenToLinkChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $links an array with the existing links (linkName=>WigiiGraphNode), which have been removed
	 * @param $linkAttributes an array of array containing the link attributes for each removed link (linkName=>[key=>value])
	 */
	 ...
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $linkName the name of the link which has an attribute which has changed.
	 * @param $key the key of the attribute which has been set
	 * @param $oldValue the existing value which now changed
	 * @param $newValue the new set value
	 */
	 ...
	 * This event is triggered only if the method listenToLinkAttributeChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $linkName the name of the link which has some attributes which have changed.
	 * @param $oldAttributes an array with the existing attributes values (key=>value), which now changed
	 * @param $newAttributes an array with the new attributes values (key=>value)
	 */
	 ...
	 * This event is triggered only if the method listenToLinkAttributeChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $linkName the name of the link which has some attributes which have been removed.
	 * @param $attributes an array with the existing attributes values (key=>value), which have been removed
	 */
	 ...
	 * This event is triggered only if the method listenToLinkAttributeChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which triggered the event
	 * @param $linkName the name of the link which has all the attributes which have been removed.
	 * @param $attributes an array with the existing attributes values (key=>value), which have been removed
	 */
	 ...
	 * This event is triggered only if the method listenToLinkChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance which has been linked
	 * @param $linkName the name of the link
	 * @param $originNode the WigiiGraphNode instance which created the link
	 */
	 ...
	 * This event is triggered only if the method listenToLinkChange returns true.
	 * @param $wigiiGraphNode the WigiiGraphNode instance for which a link has been removed
	 * @param $linkName the name of the link
	 * @param $originNode the WigiiGraphNode instance which removed the link
	 */
