 ...
 */
class CMSyncSubscriberListBatch_ExtendedTabs extends CMSyncSubscriberListBatch  {
	//to take configuration file: config_CMSyncSubscriberListBatch_ExtendedTabs.php
}