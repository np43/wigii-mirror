...
--
-- Structure de la table `Groups_Activities`
--
...
CREATE TABLE IF NOT EXISTS `Users` (
  ...
  `emailProofKey` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `emailProof` varchar(254) COLLATE utf8_unicode_ci DEFAULT NULL,
